...
sleep 3
tmux send-keys -t ccint:cli "exec node src/control-cli.ts -i --server http://127.0.0.1:8790 --credential smoke-cred" Enter
sleep 18
tmux send-keys -t ccint:cli "/rc" Enter
sleep 8
echo "=== injection HITs ==="; grep "HIT" /tmp/ccc-interactive.log
